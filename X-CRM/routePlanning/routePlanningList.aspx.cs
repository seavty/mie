...
namespace X_CRM.routePlanning
{
    public partial class routePlanningList : System.Web.UI.Page
    {
        ...
        string screen = "tblRoutePlanningFind";
        string grid = "tblRoutePlanningList";
                ...
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        ((System.Web.UI.HtmlControls.HtmlGenericControl)Master.FindControl("dvLeft")).InnerHtml =
                            cls.loadTab(db, "tblRoutePlanning", "tblRoutePlanning", 1, showCTab: true);
                    }
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Route Planning", "plus", "success", "window.location = 'routePlanning.aspx'");
