...
namespace X_CRM.itemLayout2
{
    public partial class itemLayout2Find : System.Web.UI.Page
    {
        ...
        string screen = "tblitemLayout2Find";
        string grid = "tblitemLayout2List";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Layout 2", "plus", "success", "window.location = 'itemLayout2.aspx'");
