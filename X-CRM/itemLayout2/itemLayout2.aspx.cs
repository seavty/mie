...
{
    public partial class itemLayout2 : System.Web.UI.Page
    {
        ...
        string screen = "tblitemLayout2New";
        string frm = "frmMaster";
        string IDFIeld = "itl2_ItemLayout2";
        string Tab = "tblitemLayout2";
        string cTab = "tblitemLayout2";
