...
namespace X_CRM.supplier
{
    public partial class supplierList : System.Web.UI.Page
    {
        ...
        string screen = "tblSupplierFind";
        string grid = "tblSupplierList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Supplier", "plus", "success", "window.location = 'supplier.aspx'","I","tblSupplier");
