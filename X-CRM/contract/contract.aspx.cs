...
namespace X_CRM.contract
{
    public partial class contract : System.Web.UI.Page
    {
        ...
        string screen = "tblContractNew";
        string frm = "frmMaster";
        string IDFIeld = "cont_contractid";
        string Tab = "tblContract";
        string cTab = "tblContract";
            ...
            try
            {
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        {
                            sapi.defaultValue.add("cont_CustomerID", url.Get("cust_customerid"));
                        }
