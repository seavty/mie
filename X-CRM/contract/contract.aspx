<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="contract.aspx.cs" Inherits="X_CRM.contract.contract" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="headContent">
    <script>
        ...
        function saveRecord(frm, screen) {
            ...
            if (re != "error") {
                if (re[0].status == "ok") {
                    window.location = "contract.aspx?cont_contractid=" + re[0].msg;
