...
namespace X_CRM.opportunity
{
    public partial class documentList : System.Web.UI.Page
    {
            ...
            if (Request.Form["app"] == null && Request.QueryString["app"] == null)
            {
                dvUpload.InnerHtml =
                    ...
                    "<div class='input-control file full-size' data-role='input'>" +
                        ...
                        cls.baseUrl + "opportunity/documentList.aspx?app=upload&" + tabl_ColumnID + "=" + url.Get(tabl_ColumnID) +
                ...
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        ((System.Web.UI.HtmlControls.HtmlGenericControl)Master.FindControl("dvLeft")).InnerHtml =
                            cls.loadTab(db, "tblOpportunity", "sm_doc", 1, eid);
                    }
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            {
                topTitle = "Project";
                tblTop = db.readData("Select oppo_Name,cust_Name From vOpportunity Where oppo_Deleted is null and oppo_OpportunityID=" + url.Get(tabl_ColumnID));
            }
            string re = "";
