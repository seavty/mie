<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="newOpportunityItem.aspx.cs" Inherits="X_CRM.opportunity.newOpportunityItem" %>
        ...
        function saveRecord(frm, screen) {
            ...
            if (re != "error") {
                if (re[0].status == "ok") {
                    ...
                    window.location = "../opportunity/newOpportunityItem.aspx?opit_opportunityitemid=" + re[0].msg;
                } else {
                    alert(re[0].msg);
                }
            }
