...
namespace X_CRM.glTransaction
{
    public partial class glTransactionList : System.Web.UI.Page
    {
        ...
        string screen = "tblglTransactionFind";
        string grid = "tblglTransactionList";
                ...
                if (db.connect())
                {
                    if (Request.Form["app"] != null)
                    {
                        if (Request.Form["app"].ToString() == "findRecord")
                        {
                            ...
                            string orderFieldBy = "gltr_GLTransactionID";
                            string orderBy = "";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Transaction", "plus", "success", "window.location = 'customer.aspx'");
