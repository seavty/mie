<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="dashboardDetail.aspx.cs" Inherits="X_CRM.home.dashboardDetail" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="mainContent" ClientIDMode="Static">
    ...
    <div id="dvList" class="padding10" name="dvList" runat="server"></div>
</asp:Content>
