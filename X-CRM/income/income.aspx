<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="income.aspx.cs" Inherits="X_CRM.income.income" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="headContent">
    <script>
        ...
        function saveRecord(frm, screen) {
            ...
            if (re != "error") {
                if (re[0].status == "ok") {
                    window.location = "income.aspx?inco_incomeid=" + re[0].msg;
        ...
        function delRecord(frm, screen, eid) {
            if (confirm("Delete Current Record ?")) {
                ...
                if (re == "ok") {
                    window.location = "incomeList.aspx";
                } else {
