...
namespace X_CRM.income
{
    public partial class incomeList : System.Web.UI.Page
    {
        ...
        string screen = "tblIncomeFind";
        string grid = "tblIncomeList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Income", "plus", "success", "window.location = 'income.aspx'","I","tblIncome");
