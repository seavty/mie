...
namespace X_CRM.income
{
    public partial class income : System.Web.UI.Page
    {
        ...
        string screen = "tblIncomeNew";
        string frm = "frmMaster";
        string IDFIeld = "inco_incomeid".ToLower();
        string Tab = "tblIncome";
        string cTab = "tblIncome";
            ...
            try
            {
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        sapi.defaultValue.add("inco_Date", DateTime.UtcNow.AddHours(7).ToString("yyyy-MM-dd"));
