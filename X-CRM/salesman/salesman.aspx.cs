...
namespace X_CRM.salesman
{
    public partial class salesman : System.Web.UI.Page
    {
        ...
        string screen = "tblSalesmanNew";
        string frm = "frmMaster";
        string IDFIeld = "salm_salesmanid";
        string Tab = "tblSalesman";
        string cTab = "tblSalesman";
        ...
        void init()
        {
            if (!string.IsNullOrEmpty(cls.checkSession()))
            {
                Response.Write(cls.checkSession());
                db.close();
                cls.endRequest();
                Response.End();
            }
