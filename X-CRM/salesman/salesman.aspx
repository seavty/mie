<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="salesman.aspx.cs" Inherits="X_CRM.salesman.salesman" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="headContent">
    <script>
        ...
        function saveRecord(frm, screen) {
            ...
            if (re != "error") {
                if (re[0].status == "ok") {
                    window.location = "salesman.aspx?salm_salesmanid=" + re[0].msg;
        ...
        function delRecord(frm, screen, eid) {
            if (confirm("Delete Current Record ?")) {
                ...
                if (re == "ok") {
                    window.location = "salesmanList.aspx";
                } else {
