...
namespace X_CRM.salesman
{
    public partial class salesmanList : System.Web.UI.Page
    {
        ...
        string screen = "tblSalesmanFind";
        string grid = "tblSalesmanList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Salesman", "plus", "success", "window.location = 'salesman.aspx'","I","tblSalesman");
