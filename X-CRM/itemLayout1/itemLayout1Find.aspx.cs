...
namespace X_CRM.itemLayout1
{
    public partial class itemLayout1Find : System.Web.UI.Page
    {
        ...
        string screen = "tblitemLayout1Find";
        string grid = "tblitemLayout1List";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Layout 1", "plus", "success", "window.location = 'itemLayout1.aspx'");
