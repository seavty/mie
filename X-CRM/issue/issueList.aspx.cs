...
namespace X_CRM.issue
{
    public partial class issueList : System.Web.UI.Page
    {
        ...
        string screen = "tblIssueFind";
        string grid = "tblIssueList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Issue", "plus", "success", "window.location = 'issue.aspx'","I","tblIssue");
