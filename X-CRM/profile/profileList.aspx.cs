...
namespace X_CRM.profile
{
    public partial class profileList : System.Web.UI.Page
    {
        ...
        string screen = "sys_ProfileFind";
        string grid = "sys_ProfileList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Profile", "plus", "success", "window.location = 'profile.aspx'");
