...
namespace X_CRM.purchaseOrder
{
    public partial class purchaseOrderList : System.Web.UI.Page
    {
        ...
        string screen = "tblPurchaseOrderFind";
        string grid = "tblPurchaseOrderList";
                ...
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        ((System.Web.UI.HtmlControls.HtmlGenericControl)Master.FindControl("dvLeft")).InnerHtml =
                            cls.loadTab(db, "tblPurchaseOrder", "tblPurchaseOrder", 1, showCTab: true);
                    }
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Purchase Order", "plus", "success", "window.location = 'purchaseOrder.aspx'","I","tblPurchaseOrder");
