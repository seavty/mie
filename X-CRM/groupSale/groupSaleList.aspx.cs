...
namespace X_CRM.groupSale
{
    public partial class groupSaleList : System.Web.UI.Page
    {
        ...
        string screen = "tblGroupSaleFind";
        string grid = "tblGroupSaleList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Group Sale", "plus", "success", "window.location = 'groupSale.aspx'");
