<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="groupSale.aspx.cs" Inherits="X_CRM.groupSale.groupSale" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="headContent">
    <script>
        ...
        function saveRecord(frm, screen) {
            ...
            if (re != "error") {
                if (re[0].status == "ok") {
                    window.location = "groupSale.aspx?grsl_groupsaleid=" + re[0].msg;
        ...
        function delRecord(frm, screen, eid) {
            if (confirm("Delete Current Record ?")) {
                ...
                if (re == "ok") {
                    window.location = "groupSaleList.aspx";
                } else {
