...
namespace X_CRM.warehouse
{
    public partial class warehouseList : System.Web.UI.Page
    {
        ...
        string screen = "tblWarehouseFind";
        string grid = "tblWarehouseList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Warehouse", "plus", "success", "window.location = 'warehouse.aspx'");
