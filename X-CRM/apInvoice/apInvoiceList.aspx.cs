...
{
    public partial class apInvoiceList : System.Web.UI.Page
    {
                ...
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        ((System.Web.UI.HtmlControls.HtmlGenericControl)Master.FindControl("dvLeft")).InnerHtml =
                            cls.loadTab(db, "tblapInvoice", "tbaplInvoice", 1, showCTab: true);
                    }
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New AP Invoice", "plus", "success", "window.location = 'apInvoice.aspx'","I","tblAPInvoice");
