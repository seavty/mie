...
namespace X_CRM.user
{
    public partial class userProfile : System.Web.UI.Page
    {
        ...
        string screen = "sys_UserProfileNew";
        string frm = "frmMaster";
        string IDFIeld = "uspr_UserProfileID".ToLower();
        string Tab = "sys_UserProfile";
        string cTab = "sys_UserProfile";
                ...
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                sapi.defaultValue.add("uspr_UserID", url.Get("user_userid").ToString());
                            }
                        }
