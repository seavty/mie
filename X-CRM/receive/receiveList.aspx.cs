...
namespace X_CRM.receive
{
    public partial class receiveList : System.Web.UI.Page
    {
        ...
        string screen = "tblReceiveFind";
        string grid = "tblReceiveList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Receive", "plus", "success", "window.location = 'receive.aspx'","I","tblReceive");
