...
{
    public partial class mobileSale : System.Web.UI.Page
    {
        ...
        string screen = "tblMobileSaleFind";
        string grid = "tblMobileSaleList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Mobile Sale", "plus", "success", "window.location = 'mobileSale.aspx'");
