...
namespace X_CRM.production
{
    public partial class productionList : System.Web.UI.Page
    {
        ...
        string screen = "tblProductionFind";
        string grid = "tblProductionList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Production", "plus", "success", "window.location = 'Production.aspx'");
