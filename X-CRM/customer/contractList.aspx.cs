...
namespace X_CRM.customer
{
    public partial class contractList : System.Web.UI.Page
    {
        ...
        string screen = "tblContractFind";
        string grid = "tblContractList";
                ...
                if (db.connect())
                {
                    ...
                    if (Request.Form["app"] != null)
                    {
                        ...
                        if (Request.Form["app"].ToString() == "SSA")
                        {
                            ...
                            {
                                filter = " cont_customerid=" + Request.Form["cust_customerid"].ToString();
                            }
                    ...
                    if (Request.Form["app"] != null)
                    {
                        if (Request.Form["app"].ToString() == "findRecord")
                        {
                            ...
                            string orderFieldBy = "cont_Name";
                            string orderBy = "";

                            if (!string.IsNullOrEmpty(url.Get("cust_customerid")))
                            {
                                filter = " and cont_customerid=" + url.Get("cust_customerid");
                            }
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            if (!string.IsNullOrEmpty(url.Get("cust_customerid")))
            {
                sapi.Buttons.add("New Contract", "plus", "success",
                    "window.location = '../contract/contract.aspx?cust_customerid=" + url.Get("cust_customerid") + "'");
