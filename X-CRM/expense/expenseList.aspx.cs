...
namespace X_CRM.expense
{
    public partial class expenseList : System.Web.UI.Page
    {
        ...
        string screen = "tblExpenseFind";
        string grid = "tblExpenseList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Expense", "plus", "success", "window.location = 'expense.aspx'","I","tblExpense");
