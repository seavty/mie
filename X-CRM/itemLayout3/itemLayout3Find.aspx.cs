...
using System.Data;
namespace X_CRM.itemLayout3
{
    public partial class itemLayout3Find : System.Web.UI.Page
    {
        ...
        string screen = "tblitemLayout3Find";
        string grid = "tblitemLayout3List";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Layout 3", "plus", "success", "window.location = 'itemLayout3.aspx'");
