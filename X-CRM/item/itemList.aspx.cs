...
namespace X_CRM.item
{
    public partial class itemList : System.Web.UI.Page
    {
        ...
        string screen = "tblItemGroupFind";
        string grid = "tblItemGroupList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Item", "plus", "success", "window.location = 'item.aspx'","I", "tblItemGroup");
            re = cls.loadScreen(db, screen, frm, ref tblData, eid, null, "Services");
            return re;
        }
    }
}