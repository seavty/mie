...
namespace X_CRM.stockTransfer
{
    public partial class stockTransferList : System.Web.UI.Page
    {
                ...
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        ((System.Web.UI.HtmlControls.HtmlGenericControl)Master.FindControl("dvLeft")).InnerHtml =
                            cls.loadTab(db, "tblstockTransfer", "tbstockTransfer", 1, showCTab: true);
                    }
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Stock Transfer", "plus", "success", "window.location = 'stockTransfer.aspx'", "I", "tblStockTransfer");
