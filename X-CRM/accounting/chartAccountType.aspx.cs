...
{
    public partial class chartAccountType : System.Web.UI.Page
    {
        ...
        string screen = "tblChartAccountTypeNew";
        string frm = "frmMaster";
        string IDFIeld = "cact_chartaccounttypeid";
        string Tab = "tblChartAccountType";
        string cTab = "tblChartAccountType";
        ...
        string saveRecord()
        {
            ...
            if (str.tbl != null)
            {
                ...
                {
                    if (!vals.ContainsKey("cact_chartaccounttypeid"))
                    {
