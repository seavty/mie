<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="chartAccount.aspx.cs" Inherits="X_CRM.accounting.chartAccount" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="headContent">
    <script>
        ...
        function saveRecord(frm, screen) {
            ...
            if (re != "error") {
                if (re[0].status == "ok") {
                    window.location = "chartAccount.aspx?chac_chartaccountid=" + re[0].msg;
        ...
        function delRecord(frm, screen, eid) {
            if (confirm("Delete Current Record ?")) {
                ...
                if (re == "ok") {
                    window.location = "chartAccountList.aspx";
                } else {
