...
{
    public partial class chartAccountTypeList : System.Web.UI.Page
    {
        ...
        string screen = "tblChartAccountTypeFind";
        string grid = "tblChartAccountTypeList";
                ...
                if (db.connect())
                {
                    if (Request.Form["app"] != null)
                    {
                        if (Request.Form["app"].ToString() == "findRecord")
                        {
                            ...
                            string orderFieldBy = "cact_Account";
                            string orderBy = "ASC";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Chart Account Type", "plus", "success", "window.location = 'chartAccountType.aspx'");
