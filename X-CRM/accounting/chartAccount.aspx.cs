...
namespace X_CRM.accounting
{
    public partial class chartAccount : System.Web.UI.Page
    {
        ...
        string screen = "tblChartAccountNew";
        string frm = "frmMaster";
        string IDFIeld = "chac_chartaccountid";
        string Tab = "tblChartAccount";
        string cTab = "tblChartAccount";
        ...
        string saveRecord()
        {
            ...
            if (str.tbl != null)
            {
                ...
                {
                    if (!vals.ContainsKey("chac_chartaccountid"))
                    {
