<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="journalList.aspx.cs" Inherits="X_CRM.accounting.journalList" %>
    ...
    <script>
        ...
        function findCustomerRecord(id) {
            ...
            $.ajax({
                ...
                data: "app=getJournalDetailList&jour_journalno=" + JournalNo + "&jour_date=" + JournalDate + "&jour_date_to=" + JournalDate_To + "&jour_desc=" + JournalDesc,
                type: "POST",
                async: false,
                error: function () {
                    return "error";
