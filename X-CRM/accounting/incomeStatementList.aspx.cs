...
{
    public partial class incomeStatementList : System.Web.UI.Page
    {
        ...
        string screen = "tblJournalFind_IS";
            ...
            try
            {
                if (db.connect())
                {
                    ...
                    else
                    {
                        ...
                        sapi.defaultValue.add("jour_Date_To", DateTime.UtcNow.AddHours(7).ToString("yyyy-MM-dd HH:mm"));
