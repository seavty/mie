...
{
    public partial class accountTypeList : System.Web.UI.Page
    {
        ...
        string screen = "tblAccountTypeFind";
        string grid = "tblAccountTypeList";
                ...
                if (db.connect())
                {
                    if (Request.Form["app"] != null)
                    {
                        if (Request.Form["app"].ToString() == "findRecord")
                        {
                            ...
                            string orderFieldBy = "acct_ChartAccountTypeID";//"acct_Name";
                            string orderBy = "ASC";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New AccountType", "plus", "success", "window.location = 'accountType.aspx'");
