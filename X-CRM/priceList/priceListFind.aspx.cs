...
{
    public partial class priceListFind : System.Web.UI.Page
    {
        ...
        string screen = "tblPriceListFind";
        string grid = "tblPriceListList";
        ...
        string loadScreen(string eid, global::sapi.sapi.recordMode mode)
        {
            ...
            string re = "";
            sapi.Buttons.add("New Price List", "plus", "success", "window.location = 'priceList.aspx'","I","tblPriceList");
