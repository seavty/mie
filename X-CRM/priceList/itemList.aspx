<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="itemList.aspx.cs" Inherits="X_CRM.priceList.itemList" %>
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="headContent">
    <script>
        ...
        function addItem(id) {
            var _eid = getUrlVars(window.location.href)["prls_pricelistid"];
            $.ajax({
                url: "",
                data: "app=newItem&id=" + _eid + "&eid=" + id,
                type: "POST",
                async: false,
                error: function () {
                    return "error";
